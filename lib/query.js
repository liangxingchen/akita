...
function Query(path, client) {
  ...
  me.limit = function (size) {
    return me._compute('prePage', size);
  };
  ...
  me.find = function (conditions) {
    ...
    if (conditions && conditions.params) {
      ...
      me._conditions.data.params.filters = Object.assign({},me._conditions.data.filters,conditions);
    }
    return me;
  };
  ...
  me.findOne = function (conditions) {
    ...
    if (typeof conditions === 'object') {
      ...
      if(!me._conditions.data.params.prePage){
          me._conditions.data.params.prePage = 1;
      }
    } else {
      me._conditions.id = conditions;
    }
