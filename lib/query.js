...
function Query(path, client) {
    ...
    me.where = function (conditions, value) {
        ...
        if (typeof conditions === 'object') {
            if (conditions && conditions.params) {
                ...
                me._conditions.data.params = Object.assign({}, me._conditions.data.params, conditions);
            }
        } else {
            if (value === undefined) {
                ...
                me._conditions.data.params[conditions] = value;
            }
        }
        return me;
    };
    ...
    me.compute = function (type, value) {
        if (type.indexOf('$') >= 0) {
            if (me._lastCondition) {
                me._conditions.data.params[me._lastCondition][type] = value;
            }
        } else {
            if (!me._conditions.data.params) {
                me._conditions.data.params = {};
    ...
    me.eq = function (value) {
        if (me._lastCondition) {
            me._conditions.data.params[me._lastCondition] = value;
        }
        return me;
    };
    ...
    me.lt = function (value) {
        return me.compute('$lt', value);
    };

    me.lte = function (value) {
        return me.compute('$lte', value);
    };

    me.gt = function (value) {
        return me.compute('$gt', value);
    };

    me.gte = function (value) {
        return me.compute('$gte', value);
    };

    me.limit = function (size) {
        return me.compute('limit', size);
    };

    me.page = function (size) {
        return me.compute('page', size);
    };

    me.sort = function (sortBy) {
        return me.compute('sort', sortBy);
    };
